      ...
      <div className="space-y-8 text-center">
        ...
        <div className="space-y-3">
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-xs mx-auto leading-relaxed">
            4+ years building scalable systems and leading engineering teams
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-center space-x-2">
            ...
            <a
              href="mailto:dharmik.harkhani@outlook.com	"
              className="text-sm text-gray-600 hover:text-gray-900"
            >
              dharmik.harkhani@outlook.com
            </a>
          </div>
          ...
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-sm text-gray-600">Elmwood Park, NJ</span>
          </div>
          ...
          <div className="flex items-center justify-center space-x-4 pt-2">
            ...
            <a
              href="https://www.linkedin.com/in/dharmik-harkhani/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 text-gray-600 hover:text-gray-900"
            >
